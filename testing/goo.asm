...
free_var_4:	; location of __bin_integer_to_fraction
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 1538

free_var_5:	; location of __integer-to-fraction
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 1186

free_var_6:	; location of error
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 785

free_var_7:	; location of fold-left
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 1511

free_var_8:	; location of fraction->real
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 402
...
free_var_10:	; location of integer->real
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 380

free_var_11:	; location of integer?
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 496

free_var_12:	; location of real?
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 138
...
.L_lambda_simple_arity_check_ok_0001:
	...
	mov rax, L_constants + 1581
	push rax
	mov rax, L_constants + 1572
	push rax
	push 2	; Number of arguments
	mov rax, qword [free_var_6]	; free var error
	...
	mov rcx, 2 + 4	; Total slots (args + 4)
...
.L_lambda_simple_arity_check_ok_0003:
	...
	push rax
	push 1	; arg count
	mov rax, qword [free_var_11]	; free var integer?
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	cmp byte [rax], T_closure
	jne L_error_non_closure
...
.L_if_else_0003:
	...
	push rax
	push 1	; arg count
	mov rax, qword [free_var_5]	; free var __integer-to-fraction
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	cmp byte [rax], T_closure
	jne L_error_non_closure
...
.L_if_else_0002:
	...
	push rax
	push 1	; arg count
	mov rax, qword [free_var_12]	; free var real?
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	cmp byte [rax], T_closure
	jne L_error_non_closure
	...
	push rax
	push 1	; arg count
	mov rax, qword [free_var_10]	; free var integer->real
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	cmp byte [rax], T_closure
	jne L_error_non_closure
...
.L_if_else_0001:
	...
	; Start recycling the current frame
	mov rbx, [rbp]	; Old frame pointer
	mov rcx, 0 + 4	; Total slots (args + 4)
	lea rdi, [rbx - 8]	; Source: Current frame (bottom-up)
	lea rsi, [rsp - 8 * rcx]	; Destination: New frame (top-down)
...
.L_if_else_000c:
	...
	push rax
	push 1	; arg count
	mov rax, qword [free_var_4]	; free var __bin_integer_to_fraction
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	cmp byte [rax], T_closure
	jne L_error_non_closure
...
.L_if_else_0005:
	...
	push rax
	push 1	; arg count
	mov rax, qword [free_var_8]	; free var fraction->real
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	cmp byte [rax], T_closure
	jne L_error_non_closure
...
.L_lambda_opt_arity_check_more_0001:
	...
	mov r9, rsp
	sub r8, 0 ; calculate the number of optional arguments
...
.L_lambda_opt_stack_adjusted_0001:
	...
	mov rax, qword [free_var_7]	; free var fold-left
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	; Verify the procedure is a closure
	cmp byte [rax], T_closure
	...
	; Start recycling the current frame
	mov rbx, [rbp]	; Old frame pointer
	mov rcx, 3 + 4	; Total slots (args + 4)
	lea rdi, [rbx - 8]	; Source: Current frame (bottom-up)
	lea rsi, [rsp - 8 * rcx]	; Destination: New frame (top-down)
...
.L_lambda_simple_end_0004:	; new closure is in rax
	...
	; Start recycling the current frame
	mov rbx, [rbp]	; Old frame pointer
	mov rcx, 1 + 4	; Total slots (args + 4)
	lea rdi, [rbx - 8]	; Source: Current frame (bottom-up)
	lea rsi, [rsp - 8 * rcx]	; Destination: New frame (top-down)
...
.L_lambda_simple_end_0002:	; new closure is in rax
	...
	; preparing a non-tail-call
	mov rax, L_constants + 1631
	push rax
	mov rax, L_constants + 1622
	push rax
	push 2	; arg count
	mov rdi, (1 + 8 + 8)	; sob closure
	call malloc
